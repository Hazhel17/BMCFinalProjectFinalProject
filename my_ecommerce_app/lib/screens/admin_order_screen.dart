...
class _AdminOrderScreenState extends State<AdminOrderScreen> {
  ...
  // 2. Function to update the status in Firestore
  // MODIFIED: Accept userId
  Future<void> _updateOrderStatus(String orderId, String newStatus, String userId) async {
    try {
      ...
      // NEW LOGIC: Create a new notification document
  ...
  // 4. Function to show the update status dialog
  // MODIFIED: Accept userId
  void _showStatusDialog(String orderId, String currentStatus, String userId) {
    showDialog(
      context: context,
      // FIX: RENAME the builder's context to dialogContext
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: statuses.map((status) {
              // 6. Create a ListTile for each status
              return ListTile(
                title: Text(status),
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // Get the userId from the order data
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Text(
                    'User: ${orderData['userId']}\nTotal: P${(orderData['totalPrice']).toStringAsFixed(2)} | Date: $formattedDate',
                  ),
                  isThreeLine: true,
                  ...
                  trailing: Chip(
                    ...
                    backgroundColor: // Ternary operator to set color
