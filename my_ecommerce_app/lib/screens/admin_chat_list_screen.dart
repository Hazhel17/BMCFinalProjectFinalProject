    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        stream: FirebaseFirestore.instance
            .collection('chats')
            .orderBy('lastMessageAt', descending: true) // Sort by most recent message
            .snapshots(),
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final String userId = chatDoc.id; // The user ID is the chat document ID
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => ChatScreen(
                        chatRoomId: userId, // Pass the user's ID
                        userName: userEmail, // Pass the email for the app bar title
                      ),
                    ),
                  );
                },
