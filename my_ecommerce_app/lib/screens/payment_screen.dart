...
import 'package:my_ecommerce_app/screens/order_success_screen.dart';
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  // Part 2: The _processPayment Logic
  Future<void> _processPayment() async {
    ...
    try {
      ...
      // Wait for 3 seconds to simulate a network request
      await Future.delayed(const Duration(seconds: 3));

      // 3. If "successful", we get the CartProvider.
      // (listen: false is critical for calls inside functions)
      final cartProvider = Provider.of<CartProvider>(context, listen: false);

      // 4. Call the functions to place order and clear cart
  ...
  // Part 3: The build Method (UI)
  @override
  Widget build(BuildContext context) {
    // 1. Use the Philippine Peso sign (P)
